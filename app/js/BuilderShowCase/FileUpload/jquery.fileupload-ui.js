...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        ...
        options: {
            ...
            // Callback for successful uploads:
                ...
                if (data.context) {
                    data.context.each(function (index) {
                        ...
                        that._transition($(this));
                        var node = $(this);
                        template = that._renderDownload([file]).css('height', node.height()).replaceAll(node);
            ...
            start: function (e) {
                var that = $(this).data('fileupload');
                that._transition($(this).find('.fileupload-buttonbar .progress'));
        ...
        _renderTemplate: function (func, files) {
            ...
            var html = $(this.options.templatesContainer).html(result).children();
            this._trigger('onRenderTemplate');
            return html;
        },
            ...
            nodes.find('.preview span').each(function (index, element) {
                ...
                if (options.previewSourceFileTypes.test(file.type) &&
                    ...
                    that._processingQueue = that._processingQueue.pipe(function () {
                        ...
                        that._renderPreview(file, $(element));
        ...
        _startHandler: function (e) {
		    ...
		    e.data.fileupload._trigger('startHandler', e, data );
