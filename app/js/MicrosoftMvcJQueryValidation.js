...
function __MVC_EnableClientValidation(validationContext) {
    ...
    var theForm = $jq("#" + validationContext.FormId);
    ...
    var options = {
        ...
        errorPlacement: function(error, element) {
            ...
            $jq(messageSpan).empty();
            $jq(messageSpan).removeClass("field-validation-valid");
            $jq(messageSpan).addClass("field-validation-error");
        ...
        success: function(label) {
            var messageSpan = $jq(label.attr("_for_validation_message"));
            $jq(messageSpan).empty();
            $jq(messageSpan).addClass("field-validation-valid");
            $jq(messageSpan).removeClass("field-validation-error");
        }
    };
